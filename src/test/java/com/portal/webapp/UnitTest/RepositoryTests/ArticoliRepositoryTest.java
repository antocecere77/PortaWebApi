package com.portal.webapp.UnitTest.RepositoryTests;
...
import com.portal.webapp.Application;
...
public class ArticoliRepositoryTest
{
	...
	{		
		List<Article> items = articoliRepository.getByDescription("ACQUA ULIVETO%");
	...
	{
		List<Article> items = articoliRepository.findByDescrizioneLike("ACQUA%",PageRequest.of(0, 10));
	...
	public void TestfindByCodArt() throws Exception
	{
		assertThat(articoliRepository.findByCodArt("002000301"))
				.extracting(Article::getDescrizione)
