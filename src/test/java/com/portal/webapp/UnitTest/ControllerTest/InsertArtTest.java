package com.portal.webapp.UnitTest.ControllerTest;
...
public class InsertArtTest
{
	...
	String JsonData =  
			"{\r\n" + 
			"    \"codArt\": \"123Test\",\r\n" + 
			"    \"descrizione\": \"Article Unit Test Inserimento\",\r\n" +
			"    \"um\": \"PZ\",\r\n" + 
			"    \"codStat\": \"TESTART\",\r\n" + 
			"    \"pzCart\": 6,\r\n" + 
			"    \"pesoNetto\": 1.75,\r\n" + 
	...
	public void D_testUpdArticolo() throws Exception
	{
		...
		assertThat(articoliRepository.findByCodArt("123Test"))
		.extracting(Article::getIdStatoArt)
		.isEqualTo("2 ");
